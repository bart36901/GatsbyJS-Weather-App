    ...
    return (
      <Layout>
          ...
          <form className="searchForm" onSubmit={this.handleSubmit} autoComplete="off">
            <p><label htmlFor="search">Search a city to fetch the forecast!.</label></p>
            <div className="searchForm__inner">
              <input id="search" className="searchForm__input" type="text" placeholder="ie Chicago,US" value={this.state.location} onChange={this.handleChange} />
